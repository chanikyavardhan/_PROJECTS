...
function playAll(songNumber){
  ...
  if(audioElement.getAttribute("src")==songFileName && !audioElement.paused){
      audioElement.pause();
      playBtn.innerHTML='<img src="C:\Users\CHANIKYA\OneDrive\Desktop\Spotify clone\images\play-button.svg">';
      
      banner.style.backgroundImage = "images\banner1.svg";
      bannerImage.setAttribute("src", "images/image.png");
      bannerHeading.textContent = "Deep Focus";
      bannerText.textContent = "Keep your focus and enjoy the serenity";
  }
      ...
      if (songNumber === 1) {
          banner.style.backgroundImage = "C:\Users\CHANIKYA\OneDrive\Desktop\Spotify clone\images\b01.png";
          bannerImage.setAttribute("src", "C:\Users\CHANIKYA\OneDrive\Desktop\Spotify clone\images\Image 1.png");
